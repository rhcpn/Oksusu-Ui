        ...
        <div class="custom-template">
          ...
          <div class="custom-template-content">
            <div class="custom-template-title">
              <a href="https://github.com/euvl/vue-notification/blob/master/README.md">{{props.item.title}}</a>
          ...
          <div class="custom-template-close"
               @click="props.close">
            <i class="icon ion-android-close">X</i>
          </div>
        </div>
      </template>
    </notifications>
...
<style>
  ...
  */
  ...
  .custom-template-content.custom-template-title {
    letter-spacing: 1px;
    text-transform: uppercase;
    font-size: 10px;
    font-weight: 600;
